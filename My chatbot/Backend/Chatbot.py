...
#Function to get real-time and time information.
...
def Chatbot(Query):
    ...
    try:
        ...
        completion = client.chat.completions.create(
            ...
            temperature = 0.7, #Adjust the randomness(higher means more random).
            top_p=1, #Use nucleus sampling to control diversity.
            stream=True, #Enable straming response.
            stop=None, #Initialize an empty string to store the AI's response.
        )
